...
const combos: Combo[] = [
  {
    ...
    description:
      "Arma tu combo perfecto a partir de 2 productos. Por compras > $55.000 recibe una tarjeta personalizada 💜",
    note: "Personalizable",
    imageUrl: "images/combos/Cajita-de-maquillaje.jpg",
  },
  {
    id: "ramo-maquillaje",
    name: "Ramo de Maquillaje",
    description:
      "Elige tus productos favoritos y te armamos un ramo hermoso para regalar o auto-consentirte.",
    note: "Personalizable",
    imageUrl: "images/combos/Ramo-de-maquillaje.jpg",
  },
  {
    ...
    note: "Personalizable",
    imageUrl: "images/combos/Malteada-de-maquillaje.jpg",
  },
  {
...
function buildWhatsAppUrlForCombo(c: Combo) {
  ...
  const parts = [
    ...
    c.price
      ? `Presupuesto/Precio: ${c.price.toLocaleString("es-CO")}`
      : "Presupuesto: (cuéntanos tu presupuesto 💜)",
  ];
    ...
    <section className="mx-auto max-w-7xl px-4 py-10">
      <header className="mb-6">
        ...
        <p className="mt-1 text-sm text-gray-600">
          Arma tu combo perfecto a partir de 2 productos. En compras superiores
          a $55.000 recibes una tarjeta personalizada 💜
        </p>
      </header>
